...
As an example, here are a couple short runs of the [play-christoffel-set](https://github.com/ology/Music-CreatingRhythms/blob/main/eg/play-christoffel-set.pl) program with steady closed hihat, and repeated Christoffel-word snare and kick:
...
**UPDATE:** I have made a Mojolicious Perl [user interface](https://github.com/ology/Groove-Tool) for a few of these concepts, for curious programmers.
